...
var Engine = {
    ...
    initFGL: function (a) {
        ...
        b.src = "/play/treasurearena/js/fgl.js";
        b.onload = function () {
    ...
    initSpil: function (a) {
        var b = document.createElement("script");
        b.src = "/play/treasurearena/js/game.js";
        b.onload = function () {
            SpilData = {
    ...
    initKongregate: function (a) {
        ...
        if (self != top || this.branding)
            if (this.branding)
                ...
                var b = document.createElement("script");
                b.src = "/play/treasurearena/kongregate_api.js";
                b.onload = function () {
    ...
    checkVersionUpdate: function () {
        $.ajax({
            url: this.isNodeWebkit ? Engine.updateServer + "/play/treasurearena/version.json" : "version.json",
            dataType: "json",
            cache: !1,
            success: function (a) {},
            async: !1
...
Engine.Elements.elements = {
    ...
    ad_cpmstar_preroll: {
        process: function () {
            ...
            var a = document.createElement("script");
            a.src = "/play/treasurearena/js/cpmstar.js?v=9";
            a.onload = function () {
